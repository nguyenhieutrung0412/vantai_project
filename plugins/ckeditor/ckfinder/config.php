 ...
 */
session_start();
define('_HTTP',(isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https://" : "http://"));
$domainName = _HTTP.$_SERVER['HTTP_HOST'];
$project = rtrim(dirname($_SERVER['SCRIPT_NAME']),'\\/').'/';
$baseURL = $domainName.$project;
...
{	
	...
	//return isset($_SESSION['admin_login']['id']);
...
$config['LicenseKey'] = '6GYGPK6528FQ53P3MTVW4ERFTLN96'; */

$config['LicenseName'] = 'logisviet.com';
$config['LicenseKey'] = 'RU99CD9LM2162KBUYDUC9RABSQSPFLDP';
...
//Phân quyền thao tác: https://www.youtube.com/watch?v=000drzijBZo
...
$config['ResourceType'][] = Array(
		'name' => 'Media',
		'url' => $baseUrl.'upload',
		'directory' => $baseDir.'upload',
		'maxSize' => 0,
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,mp3,pdf,doc,docx,xls,xlsx',
		'deniedExtensions' => '');
$config['ResourceType'][] = Array(
		'name' => 'Files',
		'url' => $baseUrl.'files',
