...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['id'])){
    ...
    {
        $rs['do_dau_ngoai_text'] = 'Dầu ngoài';
    }
    elseif($rs['do_dau_ngoai'] == 0)
    {
        $rs['do_dau_ngoai_text'] = 'Dầu nhà';
    }
    ...
    $rs['so_lit'] = number_format($rs['so_lit'], 0, ',', '.') . "";
    ...
    if($total==1){
        ...
        $str = '
        <div class="pop-up">
            <h2>Thông tin đổ dầu - mã <span class="color-0">'.$rs['id'].'</span>    <a class="exit-btn" onclick="return cancel2()">Thoát</a></h2>
            <div class="info">
                <form>
                ...
                <tbody>
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td class="td-first"><label for="">Thời gian đổ dầu: </label></td>
                        <td><input type="text" value="'.$rs['ngay_do'].'"  readonly></td>
                   
                    </tr>
                    <tr>
                    
                        <td class="td-first"><label for="">Số km lúc đổ: </label></td>
                        <td><input type="text" value="'.$rs['km_luc_do'].'"  readonly></td>
                    
                    </tr>
                    <tr>
                    
                        <td class="td-first"><label for="">Số lít: </label></td>
                        <td><input type="text" value="'.$rs['so_lit'].'"  readonly></td>                 
                    </tr>
                    <tr>
                    
                        <td class="td-first"><label for="">Nguồn dầu: </label></td>
                        <td><input type="text" value="'.$rs['do_dau_ngoai_text'].'"  readonly></td>                 
                    </tr>
                    <tr>
                    
                        <td class="td-first"><label for="">Mã số dầu trước khi đổ: </label></td>
                        <td><input type="text" value="'.$rs['msd_truockhido'].'"  readonly></td>                 
                    </tr>
                    <tr>
                    
                        <td class="td-first"><label for="">Mã số dầu sau khi đổ: </label></td>
                        <td><input type="text" value="'.$rs['msd_saukhido'].'"  readonly></td>                 
                    </tr>
                    <tr>
                    
                        <td class="td-first"><label for="">Đơn giá: </label></td>
                        <td><input type="text" value="'.$rs['don_gia'].'"  readonly></td>
