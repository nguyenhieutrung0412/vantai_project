...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($_POST['data'] == "nhanhangtaikho") {
        ...
        <div style="width:100%">
            <input type="radio" style="margin-top:30px;width:3%;" id="rd-giaokho" name ="rd-noigiao"  value="giaohangtaikho"> <label class="lb_radio" for="rd-giaokho">Giao hàng tại kho</label>
            <input type="radio" style="margin-top:5px;width:3%;" id="rd-giaodiachi" name ="rd-noigiao" value="giaohangtheodiachi" ><label class="lb_radio" for="rd-giaodiachi">Giao hàng theo địa chỉ</label>
        </div>
