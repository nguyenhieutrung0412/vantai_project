...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['id'])) {
    ...
    {
        $str_ds_tructiep = '
        <h3 style="text-align:center;font-size:22px;margin: 8px 0;">Danh sách nhận trực tiếp khách hàng</h3>
         <table >
             <thead>
                 ...
                 <tr>
                     ...
                     <th style="width:22%;">Tình trạng nhận</th>
                 </tr>
             </thead>
             <tbody>
                 '.$list_donhang_giaotructiepkhach.'
    ...
    {
        $str_ds_kho = ' 
        <h3 style="text-align:center;font-size:22px;margin: 8px 0;">Danh sách nhận tại kho</h3>
         <table >
             <thead>
    ...
    $cauhinh_rs = $cauhinh->fetch();
        ...
        <h1 style="margin:0;padding:0;text-align:center;">DANH SÁCH NHẬN HÀNG</h1><i style=" display:block;text-align:center;">Ngày ... tháng ... năm ...</i><br />
