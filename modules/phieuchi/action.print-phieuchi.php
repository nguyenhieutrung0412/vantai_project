...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['id'])){
    ...
    $rs = $result->fetch();
    $ngay = explode("-",$rs['ngaytao_phieuchi']);
    ...
    if($total==1){
       ...
       <span>'.$rs2['address'].'<br>
        ...
        <tr>
            ...
            <p style="margin:0 0 4px"><span style="width:120px;display:block;float:left">Họ và tên/ Đơn vị</span>: '.$rs['name_nguoinhan'].' - Điện thoại: '.$rs['phone_nguoinhan'].'</p>
            <p style="margin:0 0 4px"><span style="width:120px;display:block;float:left">Địa chỉ</span>: '.$rs['diachi_nguoinhan'].'</p>
            <p style="margin:0 0 4px"><span style="width:120px;display:block;float:left">Lý do chi</span>: '.$rs['noidung_chi'].'</p>
            <p style="margin:0 0 4px"><span style="width:120px;display:block;float:left">Số tiền</span>: <b style="font-size:18px">'.number_format($rs['sotien_chi']).' VND</b> - Loại thu: '.$rs['loai_thu'].'</p>
