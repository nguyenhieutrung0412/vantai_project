...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['id'])){
    ...
    if($total==1){
        ...
        $str = '
        <div class="pop-up">
            <h2>Thông tin tài xế   <a class="exit-btn" onclick="return cancel2()">Thoát</a></h2>
            <div class="info">
                <form>
                ...
                <tbody>
                   ...
                   <td class="td-first"><label for="">Mã tài xế: </label></td>
                       <td>  <input type="text" value="'.$rs['id'].'"  readonly> </td>
                   
                   </tr>
                   <tr>
                   
                        <td class="td-first"><label for="">Họ và tên: </label></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" value="'.$rs['phone_taixe'].'"  readonly></td>
                    
                    </tr>
                    <tr>
                    
                        <td class="td-first"><label for="">Địa chỉ: </label></td>
                        <td><input type="text" value="'.$rs['address_taixe'].'"  readonly></td>
                   
                    </tr>
                    <tr>
                    
                        <td class="td-first"><label for="">Số điện thoại người thân: </label></td>
                        <td><input type="text" value="'.$rs['sdt_nguoithan'].'"  readonly></td>
                    
                    </tr>
                    <tr>
                    
                        <td class="td-first"><label for="">CMND: </label></td>
                        <td><input type="text" value="'.$rs['cmnd'].'"  readonly></td>                 
                    </tr>
                    <tr>
                    
                        <td class="td-first"><label for="">Ngày vào làm: </label></td>
                        <td><input type="text" value="'.$rs['ngayvaolam'].'"  readonly></td>                 
                    </tr>
                    <tr>
                    
                        <td class="td-first"><label for="">Hạng bằng lái: </label></td>
                        <td><input type="text" value="'.$rs['hangbanglai'].'"  readonly></td>                 
                    </tr>
