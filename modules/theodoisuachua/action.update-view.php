...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['id'])){
    ...
    $rs = $result->fetch();
      //xử lý thời gian 
      $thoigian_donhang = explode("-",$rs['ngay_suachua']);
    ...
    $rs['tong_tien'] = number_format($rs['tong_tien'], 0, ',', '.') . "";
     ...
     $kt_img = $oContent->view_table("php_images","type = 'php_theodoisuachua' AND type_id = '".$id."'");
     ...
     $kt_file = $oContent->view_table("php_file","type = 'php_theodoisuachua' AND type_id = '".$id."'");
    ...
    if($total==1){
        ...
        <h3>Cập nhật thông tin sửa chữa - mã <span class="color-0">'.$rs['id'].'</span></h3>
         ...
         <tbody>
            ...
            <tr>
             ...
             <tr>
                 ...
                 <td colspan = "2">
                    <div class="input-formnguoinhan">
                        <label>Ngày đổ dầu: </label> <input type="text" class="time_input picker" id="datepicker_2" name="ngay_suachua"  value="'.$thoigian_donhang_dmyyyy.'" required>
             ...
             <tr>
                ...
                <td><input type="text"  name="km_luc_suachua" value="'.$rs['km_luc_suachua'].'"  required></td>
            </tr>
             <tr>
