...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $str = '
        <div class="pop-up">
        <h3>Màn hình nhập liệu theo dõi sửa chữa</h3>
        ...
        <tbody class="add-theodoisuachua">
            <tr>
                <td>'.$stt.'</td>
                <td><input type="text" class="picker"  name="data['.$stt.'][ngay_suachua]"  required></td>
                <td> 
                ...
                <td><input type="text" class=" " id="" name="data['.$stt.'][km_luc_suachua]"  required></td>
