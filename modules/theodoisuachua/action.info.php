...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['id'])){
    ...
    if($total==1){
        ...
        $str = '
        <div class="pop-up">
            <h2>Thông tin sữa chữa - mã <span class="color-0">'.$rs['id'].'</span>    <a class="exit-btn" onclick="return cancel2()">Thoát</a></h2>
            <div class="info">
                <form>
                ...
                <tbody>
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td class="td-first"><label for="">Nội dung sửa chữa: </label></td>
