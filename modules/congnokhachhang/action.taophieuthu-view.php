...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sotienbangchu  = $oClass->convert_number_to_words($sotien_conlai);
    ...
    $str = '
        ...
        <span class="close_pop">×</span>
               ...
               <tr>
                ...
                <tr>
                 ...
                 <tr>
                   ...
                   <td><input type="text"   name="sotien_bangchu" value="'.$sotienbangchu.'"  placeholder="Số tiền bằng chữ" required></td>
                </tr>
                <tr>
            ...
            <input type="hidden" value="'.$rs['id_security'].'"  name="id_congnohangtrongoi" >
