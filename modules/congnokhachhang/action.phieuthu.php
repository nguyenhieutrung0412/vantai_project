...
$url = $system->root_dir.'congnokhachhang/phieuthu';
$dp = new paging($url,$total,$limit);
$dp->current = '<a class="active_page">%d</a>';
$tpl->assign(array('divpage'=>$dp->simple(10)));


$phieu_chi = $oContent->view_pagination('php_phieuthu',"id_congnohangtrongoi = ".$id_congnohangtrongoi."  GROUP BY id DESC",$start,$limit);
