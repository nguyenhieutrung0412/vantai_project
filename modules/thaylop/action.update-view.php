...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['id'])){
    ...
    $rs = $result->fetch();
      //xử lý thời gian 
      $thoigian_donhang = explode("-",$rs['ngay_thaylop']);
    ...
    if($total==1){
        ...
        <h3>Cập nhật thông tin thay lốp - mã <span class="color-0">'.$rs['id'].'</span></h3>
             ...
             <tr>
                 ...
                 <td colspan = "2">
                    <div class="input-formnguoinhan">
                        <label>Ngày thay lốp: </label> <input type="text" class="time_input picker" id="datepicker_2" name="ngay_thaylop"  value="'.$thoigian_donhang_dmyyyy.'" required>
                       
                    </div>
                </td>
             </tr>
             <tr>
                <td class="td-first">Số km(km lúc thay lốp)</td>
                <td><input type="text"  name="km_luc_thaylop" value="'.$rs['km_luc_thaylop'].'"  required></td>
            </tr>
             <tr>
                <td class="td-first">Thay đổi vị trí lốp</td>
                <td><input type="text"  name="vitri_lop" value="'.$rs['vitri_lop'].'"  required></td>
            </tr>
             <tr>
                <td class="td-first">Số seri (*)</td>
                <td><input type="text"  name="seri" value="'.$rs['seri'].'"  required></td>
            </tr>
             <tr>
                <td class="td-first">Nội dung thay lốp</td>
