...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $str = '
        <div class="pop-up">
        <h3>Màn hình nhập liệu theo dõi thay lốp</h3>
        ...
        <tbody class="add-theodoisuachua">
            <tr>
                <td>'.$stt.'</td>
                <td><input type="text" class="picker"  name="data['.$stt.'][ngay_thaylop]"  required></td>
                <td> 
                ...
                <td><input type="text" class=" " id="" name="data['.$stt.'][km_luc_thaylop]"  required></td>
            ...
            <div class="addline">
                <a href="javascript:void(0)" class="btn-add-theodoisuachua" >Thêm dòng</a>
            </div>
