...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['id'])){
    ...
    if($total==1){
        ...
        $str = '
        <div class="pop-up">
            <h2>Thông tin thay nhớt - mã <span class="color-0">'.$rs['id'].'</span>    <a class="exit-btn" onclick="return cancel2()">Thoát</a></h2>
            <div class="info">
                <form>
                ...
                <tbody>
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td class="td-first"><label for="">Thời gian thay nhớt: </label></td>
                        <td><input type="text" value="'.$rs['ngay_suachua'].'"  readonly></td>
                   
                    </tr>
                    <tr>
                    
                        <td class="td-first"><label for="">Số km lúc thay nhớt: </label></td>
                        <td><input type="text" value="'.$rs['km_luc_suachua'].'"  readonly></td>
                    
                    </tr>
                    <tr>
                    
                        <td class="td-first"><label for="">Nội dung thay nhớt: </label></td>
