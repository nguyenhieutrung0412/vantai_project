...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
     ...
     $thoigian = explode("/",$_REQUEST['ngay_thaynhot']);
        //xử lý lấy tháng năm của ngày đổ dầu
   ...
   $data = array(
    ...
    'ngay_thaynhot'=>$gio_quocte,
    'km_luc_thaynhot'=> htmlspecialchars(trim($_REQUEST['km_luc_thaynhot'])),
    ...
    $oClass->update("php_thaynhot",$data,"id=".$data['id']);
    $oClass->upload_files('php_thaynhot',$data['id']);
    $oClass->upload_images('php_thaynhot',$data['id'],$chatluonganh);
