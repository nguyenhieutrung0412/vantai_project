...
<div class="wrapper">
	...
	<a href="?mod=user&act=update&do=new" class="btn l">'.(isset($this->merge['lang']['new'])?$this->merge['lang']['new']:'').'</a>
</div>

<div class="error hide">'.(isset($this->_data["."][0]['msg'])?$this->_data["."][0]['msg']:'').'</div>
<div class="form">

<table width="100%" border="0" cellspacing="0" cellpadding="2" class="table_list marginTop5">
  <tr>
    <th width="1%" class="th-name firstColumn">&nbsp;</th>
    <th width="41%" class="th-name">'.(isset($this->merge['lang']['name'])?$this->merge['lang']['name']:'').'</th>
    <th width="24%" class="th-name">'.(isset($this->merge['lang']['username'])?$this->merge['lang']['username']:'').'</th>
    <th width="13%" class="th-action">'.(isset($this->merge['lang']['status'])?$this->merge['lang']['status']:'').'</th>
    <th width="21%" class="th-action lastColumn">'.(isset($this->merge['lang']['actions'])?$this->merge['lang']['actions']:'').'</th>
  </tr>
  ';if(isset($this->_data['user.'])){for($i=0;$i< count($this->_data['user.']);$i++){$_tpl .= '
  <tr>
    <td class="th-name firstColumn">&nbsp;</td>
    <td class="th-name">'.(isset($this->_data["user."][$i]["fullname"])?$this->_data["user."][$i]["fullname"]:'').'</td>
    <td class="th-name">'.(isset($this->_data["user."][$i]["username"])?$this->_data["user."][$i]["username"]:'').'</td>
    <td class="th-action lastColumn"><a '.(isset($this->_data["user."][$i]["return"])?$this->_data["user."][$i]["return"]:'').' href="?mod=user&amp;act=active&amp;id='.(isset($this->_data["user."][$i]["id"])?$this->_data["user."][$i]["id"]:'').'" title="'.(isset($this->_data["user."][$i]["status"])?$this->_data["user."][$i]["status"]:'').'"><img src="template/images/icons_default/status'.(isset($this->_data["user."][$i]["active"])?$this->_data["user."][$i]["active"]:'').'.gif"  /></a>	</td>
    <td class="th-action lastColumn"><span class="hide" '.(isset($this->_data["user."][$i]["delete"])?$this->_data["user."][$i]["delete"]:'').'><a href="?mod=user&act=permission&id='.(isset($this->_data["user."][$i]["id"])?$this->_data["user."][$i]["id"]:'').'" title="'.(isset($this->merge['lang']['permission'])?$this->merge['lang']['permission']:'').'"><img src="template/images/icons_default/permission.png" width="16" height="16" /></a></span> <span class="hide" '.(isset($this->_data["user."][$i]["delete"])?$this->_data["user."][$i]["delete"]:'').'><a href="?mod=user&act=reset&id='.(isset($this->_data["user."][$i]["id"])?$this->_data["user."][$i]["id"]:'').'" title="'.(isset($this->merge['lang']['reset_password'])?$this->merge['lang']['reset_password']:'').'"><img src="template/images/icons_default/pswd.png" width="16" height="16" /></a></span>  <span><a href="?mod=user&act=update&id='.(isset($this->_data["user."][$i]["id"])?$this->_data["user."][$i]["id"]:'').'" title="'.(isset($this->merge['lang']['edit'])?$this->merge['lang']['edit']:'').'"><img src="template/images/icons_default/edit.png" width="16" height="16" /></a></span> <span class="hide" '.(isset($this->_data["user."][$i]["delete"])?$this->_data["user."][$i]["delete"]:'').'><a href="?mod=user&act=delete&id='.(isset($this->_data["user."][$i]["id"])?$this->_data["user."][$i]["id"]:'').'" title="'.(isset($this->merge['lang']['delete'])?$this->merge['lang']['delete']:'').'" onClick="deleteConfirm(this); return false;"><img src="template/images/icons_default/delete.png" width="16" height="16" /></a></span></td>
  </tr>
  ';}}$_tpl .= '
</table>
</div>
